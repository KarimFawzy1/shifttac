...
void main() {
  group('GameRules boundary', () {
    test('ShiftGameEngine implements GameRules for shift mode', () {
      const GameRules rules = ShiftGameEngine.instance;
    ...
    test('ShiftGameEngine.restart matches instance initial()', () {
      final restarted = ShiftGameEngine.restart();
